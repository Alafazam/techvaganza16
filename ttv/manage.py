...
from app.utils import add_event_to_user,get_user,get_role,get_event,get_all_events,get_all_organisors,unregister_to_event,get_all_user_events,make_organisor,create_event
...
def get_event_users(eventName):
	...
	print even.users.all()


@manager.command
def add_organisor(eventName,email):
	print make_organisor(eventName,email)

@manager.command
def add_event(name,view_name):
	print create_event(name,view_name)
